...
#define SIZE_SLICE_1_A 6
#define SIZE_SLICE_1_I 1
#define SIZE_SLICE_1_J 16
...
__global__ void kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_1(float *dev_t3, float *dev_t2, float *dev_v2,
...
#pragma unroll 1
  for (int l = 0; l < size_internal; l += SIZE_INT_UNIT_1) {
    ...
    for (int ll = 0; ll < 6; ll++) {
      ...
      sm_a[threadIdx.x][threadIdx.y + ll * 16] =
          dev_t2[(blk_idx_a * SIZE_SLICE_1_A + ll +
                  (blk_idx_i * SIZE_SLICE_1_I + 0 +
                   (blk_idx_k * SIZE_SLICE_1_K + idx_j) * size_i) *
                      size_a) *
                     size_q +
                 (threadIdx.x + l)];
    }
    ...
    for (int ll = 0; ll < 6; ll++) {
      ...
      sm_b[threadIdx.x][threadIdx.y + ll * 16] =
    ...
    for (int ll = 0; ll < SIZE_INT_UNIT_1; ll++) {
      ...
      temp_bv[1] = sm_b[ll][idx_j + (idx_b)*SIZE_SLICE_1_J + 16];
      temp_bv[2] = sm_b[ll][idx_j + (idx_b)*SIZE_SLICE_1_J + 32];
      temp_bv[3] = sm_b[ll][idx_j + (idx_b)*SIZE_SLICE_1_J + 48];
      temp_bv[4] = sm_b[ll][idx_j + (idx_b)*SIZE_SLICE_1_J + 64];
      temp_bv[5] = sm_b[ll][idx_j + (idx_b)*SIZE_SLICE_1_J + 80];
...
// created by tc_gen_code_Kernel()
__global__ void kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_2(float *dev_t3, float *dev_t2, float *dev_v2,
                            int size_k, int size_j, int size_i, int size_c,
                            int size_b, int size_a, int size_q, int numBlk_k,
                            int numBlk_j, int numBlk_i, int numBlk_c,
                            int numBlk_b, int numBlk_a, int stride_int_t2,
...
// created by tc_gen_code_Kernel()
__global__ void kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_3(float *dev_t3, float *dev_t2, float *dev_v2,
                            int size_k, int size_j, int size_i, int size_c,
                            int size_b, int size_a, int size_q, int numBlk_k,
                            int numBlk_j, int numBlk_i, int numBlk_c,
                            int numBlk_b, int numBlk_a, int stride_int_t2,
...
// created by tc_gen_code_Kernel()
__global__ void kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_4(float *dev_t3, float *dev_t2, float *dev_v2,
                            int size_k, int size_j, int size_i, int size_c,
                            int size_b, int size_a, int size_q, int numBlk_k,
                            int numBlk_j, int numBlk_i, int numBlk_c,
                            int numBlk_b, int numBlk_a, int stride_int_t2,
...
void kiaq_bcjq_abcijk_16x16x16x16x16x16x2048(int size_a, int size_b, int size_c, int size_i,
  ...
  if (size_k % SIZE_SLICE_1_K == 0 && size_j % SIZE_SLICE_1_J == 0 &&
    ...
    if (size_q % SIZE_SLICE_1_Q == 0) {
      ...
      kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_1<<<gridsize_1, blocksize_1>>>(
      ...
      kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_2<<<gridsize_1, blocksize_1>>>(
          dev_t3, dev_t2, dev_v2, size_k, size_j, size_i, size_c, size_b,
          size_a, size_q, CEIL_DIV(size_k, SIZE_SLICE_1_K),
          CEIL_DIV(size_j, SIZE_SLICE_1_J), CEIL_DIV(size_i, SIZE_SLICE_1_I),
          CEIL_DIV(size_c, SIZE_SLICE_1_C), CEIL_DIV(size_b, SIZE_SLICE_1_B),
    ...
    if (size_q % SIZE_SLICE_1_Q == 0) {
      ...
      kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_3<<<gridsize_1, blocksize_1>>>(
          dev_t3, dev_t2, dev_v2, size_k, size_j, size_i, size_c, size_b,
          size_a, size_q, CEIL_DIV(size_k, SIZE_SLICE_1_K),
          CEIL_DIV(size_j, SIZE_SLICE_1_J), CEIL_DIV(size_i, SIZE_SLICE_1_I),
          CEIL_DIV(size_c, SIZE_SLICE_1_C), CEIL_DIV(size_b, SIZE_SLICE_1_B),
      ...
      kiaq_bcjq_abcijk_16x16x16x16x16x16x2048_4<<<gridsize_1, blocksize_1>>>(
          dev_t3, dev_t2, dev_v2, size_k, size_j, size_i, size_c, size_b,
          size_a, size_q, CEIL_DIV(size_k, SIZE_SLICE_1_K),
          CEIL_DIV(size_j, SIZE_SLICE_1_J), CEIL_DIV(size_i, SIZE_SLICE_1_I),
          CEIL_DIV(size_c, SIZE_SLICE_1_C), CEIL_DIV(size_b, SIZE_SLICE_1_B),
